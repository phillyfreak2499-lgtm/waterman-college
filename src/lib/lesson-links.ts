...
async function assertOffice(userId: string) {
  // One shared authorizer for all training authoring (this branch's builder and
  // main's studio): admin/Chancellor, the manageTraining or viewStudio perm
  // (both fold into canOpenStudio), or a live office-password unlock.
