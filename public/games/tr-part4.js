e="play";ov.classList.add("hid");}}return;}else{die(W.q.bad);return;}}die("Fell off the floor.");return;}
if(!W.done&&P.x>W.L.x-80&&P.x<W.R.x+W.R.w+40&&P.y>200&&P.gnd){ask();return;}
...
if(!W.done){const sx=W.L.x-90;ctx.fillStyle="rgba(11,42,74,.85)";ctx.fillRect(sx,140,120,28);ctx.strokeStyle="#C9A227";ctx.strokeRect(sx,140,120,28);ctx.fillStyle="#C9A227";ctx.font="bold 12px system-ui";ctx.fillText("QUESTION AHEAD",sx+10,158);}
ctx.restore();
}
